...
batch3["label"] = {
  ...
  html: `
    <div class="space-y-8 p-8 bg-white">
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div class="space-y-4">
            ...
            <div>
              ...
              <input type="password" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm" placeholder="••••••••" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-400 mb-2">
                Disabled Field
              </label>
              <input type="text" disabled class="w-full px-3 py-2 border border-gray-200 rounded-md text-sm bg-gray-100 cursor-not-allowed" placeholder="Cannot edit" />
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- Purpose & Rationale -->
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Labels provide semantic meaning and accessibility for form inputs. They improve usability by expanding the clickable area and ensuring screen readers can associate text with inputs. Required indicators help users understand form expectations at a glance.</p>
      </section>

      <!-- Anatomy -->
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Anatomy</h3>
        <div class="bg-gray-50 p-4 rounded-lg border border-gray-200 font-mono text-sm">
          <div class="mb-2">&lt;label&gt;</div>
          <div class="ml-4 text-gray-700">
            <div class="mb-1">Text content</div>
            <div class="text-gray-500">&lt;span class="text-red-500"&gt;*&lt;/span&gt; (required indicator)</div>
          </div>
        </div>
      </section>
      ...
      <!-- Variants -->
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Variants</h3>
      ...
      <!-- Code Example -->
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;label class="block text-sm font-medium text-gray-700 mb-2"&gt;
  Username
  &lt;span class="text-red-500"&gt;*&lt;/span&gt;
&lt;/label&gt;
&lt;input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md" /&gt;</code></pre>
      </section>

      <!-- Do's and Don'ts -->
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Do's and Don'ts</h3>
      ...
      <!-- Accessibility -->
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Accessibility</h3>
        <ul class="space-y-2 text-gray-700">
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Content & Style Guidelines</h3>
        <ul class="space-y-2 text-gray-700">
...
batch3["menubar"] = {
  ...
  html: `
    <div class="space-y-8 p-8 bg-white">
          ...
          <div class="border-b border-gray-200">
            <div class="flex gap-8 px-4 py-2">
              <div class="relative group">
                <button class="text-sm font-medium text-gray-700 hover:text-gray-900 pb-2 border-b-2 border-transparent hover:border-primary">
                  File
                </button>
                <div class="hidden group-hover:block absolute top-full left-0 mt-0 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">New</a>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Open</a>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Save</a>
                  <div class="border-t border-gray-200"></div>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Exit</a>
                </div>
              </div>
              <div class="relative group">
                <button class="text-sm font-medium text-gray-700 hover:text-gray-900 pb-2 border-b-2 border-transparent hover:border-primary">
                ...
                <div class="hidden group-hover:block absolute top-full left-0 mt-0 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Undo</a>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Redo</a>
                  <div class="border-t border-gray-200"></div>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Cut</a>
              ...
              <div class="relative group">
                ...
                <div class="hidden group-hover:block absolute top-full left-0 mt-0 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10">
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Zoom In</a>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Zoom Out</a>
                  <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Reset Zoom</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Menubar organizes related actions into logical groups. It provides a familiar interface pattern from desktop applications, making complex feature sets discoverable and reducing cognitive load. The horizontal layout is ideal for application-level navigation and commands.</p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;div class="flex gap-8 px-4 py-2"&gt;
  &lt;div class="relative group"&gt;
    &lt;button class="text-sm font-medium"&gt;File&lt;/button&gt;
    &lt;div class="hidden group-hover:block absolute bg-white border rounded-md shadow-lg"&gt;
      &lt;a href="#" class="block px-4 py-2 hover:bg-gray-50"&gt;New&lt;/a&gt;
      &lt;a href="#" class="block px-4 py-2 hover:bg-gray-50"&gt;Open&lt;/a&gt;
    &lt;/div&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
      </section>
...
batch3["navigation-menu"] = {
  ...
  html: `
    <div class="space-y-8 p-8 bg-white">
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <nav class="border-b border-gray-200">
            <div class="flex items-center gap-8 px-6 py-4">
              <a href="#" class="text-sm font-medium text-gray-700 pb-4 border-b-2 border-transparent hover:border-primary">
                Home
              </a>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Navigation menus establish site structure and help users understand where they are and what they can access. Active state indicators (underline, color change) provide clear feedback about the current page, reducing navigation friction and improving user orientation.</p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;nav class="border-b border-gray-200"&gt;
  &lt;div class="flex items-center gap-8 px-6 py-4"&gt;
    &lt;a href="#" class="text-sm font-medium text-gray-700 pb-4 border-b-2 border-transparent hover:border-primary"&gt;
      Home
    &lt;/a&gt;
...
batch3["pagination"] = {
  ...
  html: `
    <div class="space-y-8 p-8 bg-white">
      ...
      <section>
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div class="flex items-center justify-center gap-2">
            <button class="px-3 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-md hover:bg-gray-100">
              Previous
            </button>
            <button class="px-3 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-md hover:bg-gray-100">
              1
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Pagination allows users to navigate large datasets without overwhelming them with content. It breaks information into manageable pages while providing quick access to specific pages. Active page highlighting provides clear context about current position.</p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;div class="flex items-center justify-center gap-2"&gt;
  &lt;button class="px-3 py-2 text-sm border border-gray-300 rounded-md hover:bg-gray-100"&gt;
    Previous
  &lt;/button&gt;
...
batch3["radio-group"] = {
  ...
  html: `
    <div class="space-y-8 p-8 bg-white">
          ...
          <div class="space-y-4">
            <div class="space-y-3">
              <label class="flex items-center gap-3 cursor-pointer">
                ...
                <span class="text-sm font-medium text-gray-900">Option One</span>
              </label>
              <label class="flex items-center gap-3 cursor-pointer">
                <div class="w-5 h-5 rounded-full border-2 border-gray-300"></div>
                <span class="text-sm font-medium text-gray-700">Option Two</span>
              </label>
              <label class="flex items-center gap-3 cursor-pointer">
                <div class="w-5 h-5 rounded-full border-2 border-gray-300"></div>
                <span class="text-sm font-medium text-gray-700">Option Three</span>
              </label>
            </div>
            <div class="border-t border-gray-200 pt-4 mt-4">
              <div class="text-sm font-medium text-gray-700 mb-3">Disabled State</div>
              <label class="flex items-center gap-3 cursor-not-allowed opacity-50">
                <div class="w-5 h-5 rounded-full border-2 border-gray-300"></div>
                <span class="text-sm font-medium text-gray-500">Disabled Option</span>
              </label>
            </div>
          </div>
        </div>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Radio buttons are ideal when users must select exactly one option from a predefined set. The circular design and filled dot convention are universally recognized. Radio groups are more scannable and accessible than select dropdowns for small option lists (3-5 items).</p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;div class="space-y-3"&gt;
  &lt;label class="flex items-center gap-3 cursor-pointer"&gt;
    &lt;div class="w-5 h-5 rounded-full border-2 border-gray-300 flex items-center justify-center"&gt;
      &lt;div class="w-3 h-3 rounded-full bg-primary"&gt;&lt;/div&gt;
    &lt;/div&gt;
...
batch3["resizable"] = {
  ...
  html: `
    <div class="space-y-8 p-8 bg-white">
      ...
      <section>
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div class="flex gap-0 h-64 border border-gray-300 rounded">
            <div class="flex-1 bg-white p-4 border-r border-gray-300 overflow-y-auto">
              <div class="text-sm font-medium text-gray-700 mb-2">Left Panel</div>
              <p class="text-xs text-gray-600">Resize by dragging the divider between panels. This panel can contain navigation, content lists, or settings.</p>
            </div>
            <div class="w-1 bg-gray-300 hover:bg-primary cursor-col-resize transition-colors"></div>
            <div class="flex-1 bg-white p-4 overflow-y-auto">
              <div class="text-sm font-medium text-gray-700 mb-2">Right Panel</div>
              <p class="text-xs text-gray-600">This is the main content area. Users can adjust panel widths by dragging. Perfect for split-view editors, explorers, or detail panels.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Resizable panels give users control over their workspace layout. This is essential for productivity applications where users need to balance navigation, content, and details views. Users can optimize layouts for their specific workflows.</p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;div class="flex gap-0 h-64 border border-gray-300 rounded"&gt;
  &lt;div class="flex-1 bg-white p-4 border-r border-gray-300 overflow-y-auto"&gt;
    Left Panel
  &lt;/div&gt;
  &lt;div class="w-1 bg-gray-300 hover:bg-primary cursor-col-resize transition-colors"&gt;&lt;/div&gt;
    ...
    <div class="space-y-8 p-8 bg-white">
      ...
      <section>
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div class="space-y-4">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Choose a Framework</label>
              <div class="relative w-full">
                <button class="w-full px-4 py-2 text-left text-sm border border-gray-300 rounded-md bg-white flex items-center justify-between hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-primary">
                  <span class="text-gray-500">Select an option...</span>
                  <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                  </svg>
                </button>
                <div class="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-300 rounded-md shadow-lg hidden z-10">
                  <div class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">React</div>
                  <div class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">Vue</div>
                  <div class="px-4 py-2 text-sm text-white bg-primary cursor-pointer">Angular</div>
                  <div class="px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer">Svelte</div>
                </div>
              </div>
            </div>
            <div>
              ...
              <div class="relative w-full">
                <button class="w-full px-4 py-2 text-left text-sm border border-gray-300 rounded-md bg-white flex items-center justify-between hover:border-gray-400">
                  <span class="text-gray-900">Next.js</span>
                  <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                  </svg>
                </button>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Select dropdowns save space by hiding options until needed. They're ideal for long lists (6+ options) or when space is limited. The dropdown pattern is universally understood and supports keyboard navigation, making them accessible and intuitive.</p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;div class="relative w-full"&gt;
  &lt;button class="w-full px-4 py-2 text-left text-sm border border-gray-300 rounded-md bg-white flex items-center justify-between"&gt;
    &lt;span&gt;Select an option...&lt;/span&gt;
    &lt;svg class="w-4 h-4"&gt;...&lt;/svg&gt;
  &lt;/button&gt;
  &lt;div class="absolute top-full left-0 right-0 mt-2 bg-white border border-gray-300 rounded-md shadow-lg"&gt;
    &lt;div class="px-4 py-2 text-sm hover:bg-gray-100 cursor-pointer"&gt;Option 1&lt;/div&gt;
...
batch3["separator"] = {
  ...
  html: `
    <div class="space-y-8 p-8 bg-white">
      ...
      <section>
        ...
        <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <div class="space-y-6">
            ...
            <div>
              <h3 class="text-sm font-bold text-gray-900 mb-4">Horizontal Separators</h3>
              <div class="space-y-4">
            ...
            <!-- Vertical Separators -->
            <div>
              <h3 class="text-sm font-bold text-gray-900 mb-4">Vertical Separators</h3>
              <div class="flex items-center gap-4">
                <span class="text-sm text-gray-700">Item One</span>
                <div class="h-6 w-px bg-gray-300"></div>
                <span class="text-sm text-gray-700">Item Two</span>
                <div class="h-6 w-px bg-gray-300"></div>
                <span class="text-sm text-gray-700">Item Three</span>
              </div>
            </div>
            ...
            <div>
              <h3 class="text-sm font-bold text-gray-900 mb-4">With Text Content</h3>
              <div class="text-sm text-gray-700">
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Purpose & Rationale</h3>
        <p class="text-gray-700 mb-2">Separators provide visual breaks between content sections, improving scannability and reducing cognitive load. They help define content hierarchy and create breathing room in dense layouts. Separators are less visually heavy than divider cards or boxes.</p>
      </section>
      ...
      <section>
        <h3 class="text-xl font-bold mb-3 text-gray-900">Code Example</h3>
        <pre class="bg-gray-900 text-gray-100 p-4 rounded-lg overflow-x-auto text-sm font-mono"><code>&lt;!-- Horizontal --&gt;
&lt;div class="h-px bg-gray-300"&gt;&lt;/div&gt;
